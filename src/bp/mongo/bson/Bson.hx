...
extern class BsonTopLevel {
	...
	static function deserializeStream(data:Buffer, startIndex:Float, numberOfDocuments:Float, documents:Array<Dynamic>, docStartIndex:Float, ?options:DeserializeOptions):Float;
}
